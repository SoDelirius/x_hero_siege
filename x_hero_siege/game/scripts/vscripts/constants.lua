...
-- These are not used except for in checks in the zones.lua Delirius
...
-- These don't seem to be used anywhere Delirius
...
-- Removed innate, difficulty, and mutliplayed abilities to move them to the files they are used within. Delirius
_G.FarmEvent_Creeps = {
